...
public class Client {
    ...
    public static void main(String argv[]) throws Exception {
        ...
        //------------------
        int RTSP_server_port = 9001;
//        String ServerHost = "192.168.0.18";
        String ServerHost = "192.168.0.11";
        theClient.ServerIPAddr = InetAddress.getByName(ServerHost);
        System.out.println(theClient.ServerIPAddr);
        //get video filename to request:
        VideoFileName = "g:\\Downloads\\movie.Mjpeg";
    ...
    class RtcpSender implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            try {
                ...
                System.out.println("Nothing to read 2" + iioe.getMessage());
            } catch (IOException ioe) {
                System.out.println("Exception caught: " + ioe);
            }
        }
    ...
    class FrameSynchronizer {
        ...
        Toolkit toolkit = Toolkit.getDefaultToolkit();
        byte[] b = new byte[]{0};
        private Image lastImage = toolkit.createImage(b, 0, 1);
